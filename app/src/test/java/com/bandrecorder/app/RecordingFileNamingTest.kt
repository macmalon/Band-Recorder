...
class RecordingFileNamingTest {
    ...
    fun `session naming follows expected convention`() {
        ...
        assertTrue(base.matches(Regex("""^session_\d{8}_\d{6}$""")))
    ...
    fun `user title maps morceau filenames to French friendly labels`() {
        assertEquals(
            "Morceau 1",
            RecordingFileNaming.userVisibleTitle("session_20260305_102030_morceau_01.wav")
        )
        assertEquals(
            "Morceau 15",
            RecordingFileNaming.userVisibleTitle("session_20260305_102030_morceau_15.wav")
        )
        assertEquals(
            "session_20260305_102030_raw.wav",
            RecordingFileNaming.userVisibleTitle("session_20260305_102030_raw.wav")
        )
    }

    @Test
    fun `segment sort key is numeric for morceau files`() {
        val key02 = RecordingFileNaming.segmentSortKey("session_20260305_102030_morceau_02.wav")
        val key10 = RecordingFileNaming.segmentSortKey("session_20260305_102030_morceau_10.wav")
        val keyRaw = RecordingFileNaming.segmentSortKey("session_20260305_102030_raw.wav")
